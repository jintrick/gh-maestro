...
以下のファイルをコミットに含めるとき、**コミット前に `/audit-worker-skills` を実行して SKILL.md との整合性を確認すること。**

対象ファイル: `scripts/spawn-worker.js` / `scripts/link-node-modules.js` / `scripts/install.js` / `scripts/poll-and-notify.js`
