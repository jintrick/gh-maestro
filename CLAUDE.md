...
PR が opened/reopened されると correctness・maintainability・resilience の 3 AI レビュアーが並列起動し、GitHub にコードレビューコメントを投稿する仕組み。対象リポジトリへのデプロイは `node scripts/setup-ai-review.js <owner/repo>`。
